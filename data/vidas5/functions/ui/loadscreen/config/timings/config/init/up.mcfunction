...
scoreboard players add VIDAS.Config VSCTInit 1
...
execute if score VIDAS.Config VSCTInit matches 1201 run scoreboard players set VIDAS.Config VSCXPCosttick 1200
