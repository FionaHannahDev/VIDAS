...
scoreboard players add VIDAS.Config VSCT8 1
...
execute if score VIDAS.Config VSCT8 matches 1201 run scoreboard players set VIDAS.Config VSCXPCosttick 1200
