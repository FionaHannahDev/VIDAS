...
scoreboard players add VIDAS.Config VSCT5 1
...
execute if score VIDAS.Config VSCT5 matches 1201 run scoreboard players set VIDAS.Config VSCXPCosttick 1200
