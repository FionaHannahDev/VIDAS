...
execute as @s at @s positioned ~ ~1.8 ~ run function vidas5:base/checks/deregistry/tracersetup
execute as @e[tag=VSRaytrace] at @s run function vidas5:base/checks/deregistry/raytracemanager
