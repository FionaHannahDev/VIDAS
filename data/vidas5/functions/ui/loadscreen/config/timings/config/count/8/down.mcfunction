...
scoreboard players remove VIDAS.Config VSCT8 1
...
execute if score VIDAS.Config VSCT8 <= VIDAS.Config VSCTtest run function vidas5:ui/loadscreen/config/timings/config/count/8/floor
