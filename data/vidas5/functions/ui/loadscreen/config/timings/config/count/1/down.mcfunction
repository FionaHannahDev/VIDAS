...
scoreboard players remove VIDAS.Config VSCT1 1
...
execute if score VIDAS.Config VSCT1 <= VIDAS.Config VSCTtest run function vidas5:ui/loadscreen/config/timings/config/count/1/floor
