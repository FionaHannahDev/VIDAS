...
scoreboard players remove VIDAS.Config VSCT5 1
...
execute if score VIDAS.Config VSCT5 <= VIDAS.Config VSCTtest run function vidas5:ui/loadscreen/config/timings/config/count/5/floor
