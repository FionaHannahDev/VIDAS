...
scoreboard players add VIDAS.Config VSCT6 1
...
execute if score VIDAS.Config VSCT6 matches 1201 run scoreboard players set VIDAS.Config VSCXPCosttick 1200
