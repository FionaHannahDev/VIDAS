...
scoreboard players remove VIDAS.Config VSCTLockout 1
...
execute if score VIDAS.Config VSCTLockout <= VIDAS.Config VSCTtest run function vidas5:ui/loadscreen/config/timings/config/lockout/floor
