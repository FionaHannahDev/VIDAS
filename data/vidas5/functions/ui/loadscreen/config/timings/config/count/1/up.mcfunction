...
scoreboard players add VIDAS.Config VSCT1 1
...
execute if score VIDAS.Config VSCT1 matches 1201 run scoreboard players set VIDAS.Config VSCXPCosttick 1200
