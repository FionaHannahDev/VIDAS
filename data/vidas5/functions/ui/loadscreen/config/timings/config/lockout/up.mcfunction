...
scoreboard players add VIDAS.Config VSCTLockout 1
...
execute if score VIDAS.Config VSCTLockout matches 1201 run scoreboard players set VIDAS.Config VSCXPCosttick 1200
