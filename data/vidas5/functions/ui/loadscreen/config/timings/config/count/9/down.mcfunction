...
scoreboard players remove VIDAS.Config VSCT9 1
...
execute if score VIDAS.Config VSCT9 <= VIDAS.Config VSCTtest run function vidas5:ui/loadscreen/config/timings/config/count/9/floor
